...
const map<QString, QStringList> GameKlotski::GameSetData =
{
   ...
   {"插翅难飞",{"4", "5", "1,0,0,1,2|4,0,1,2,2|1,3,0,1,2|1,3,3,1,2|2,2,0,2,1|2,3,1,2,1|3,0,3,1,1|3,1,3,1,1|3,2,3,1,1|3,2,2,1,1", "4,3,1"}},
   {"守口如瓶",{"4", "5", "1,0,0,1,2|4,0,1,2,2|1,0,3,1,2|1,2,1,1,2|2,4,0,2,1|2,4,2,2,1|3,2,0,1,1|3,3,0,1,1|3,2,3,1,1|3,3,3,1,1", "4,3,1"}}
};
